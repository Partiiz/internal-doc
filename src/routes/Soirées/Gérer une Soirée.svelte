<p>(En tant qu'organisateur de soirée)</p>
...
<ul>
	...
	<li>
		Donner le grade modérateur à un membre de la soirée (les modérateurs pourront accepter / refuser
		les demandes, inviter directement leurs ami sans passer par les demandes (comme l'organisateur)
		confirmer que tel ou tel membre est présent, retirer des membres mais ne pourrons pas modifier
		la date ou supprimer la soirée)
	</li>
	<li>
		Modifier les photos du lieu | Ajouter des photos de la soirée lorsqu'elle s'est déroulée
